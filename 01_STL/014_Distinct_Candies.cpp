...
int distributeCandies(vector<int> candies) {
	int n = candies.size();
	set<int> uniqueTypes;
	for(auto candy : candies) uniqueTypes.insert(candy);
	int uniqueCandies = uniqueTypes.size();
	if((n / 2) < uniqueCandies) return (n / 2);
	else return uniqueCandies;
}
